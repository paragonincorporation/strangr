...
export function parseEnvelope(raw) {
  ...
  try {
    ...
    if (!envelope || typeof envelope !== 'object' || !CLIENT_TYPES.has(envelope.type)) {
    ...
    return {
      ...
      envelope: {
        type: envelope.type,
        requestId: typeof envelope.requestId === 'string' ? envelope.requestId.slice(0, 80) : undefined,
...
export function cleanChatText(value) {
  ...
  return value.replace(/[\u0000-\u0008\u000B\u000C\u000E-\u001F\u007F]/g, '').trim().slice(0, MAX_CHAT_LENGTH)
}
