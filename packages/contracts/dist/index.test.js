...
import { avatarUploadInitRequestSchema, clientRealtimeEnvelopeSchema, countryCodeSchema, directMessageSendSchema, MAX_REALTIME_MESSAGE_BYTES, onboardingRequestSchema, parseClientRealtimeMessage, serverRealtimeEnvelopeSchema, launchCountryUpdateSchema, matchingPreferencesSchema, } from "./index.js";
describe("contracts", () => {
    ...
    test("validates authoritative match timing and cooldown errors", () => {
        ...
        expect(serverRealtimeEnvelopeSchema.safeParse({
            version: 1,
    ...
    test("normalizes country controls and requires an audit purpose", () => {
        ...
        expect(launchCountryUpdateSchema.safeParse({
    ...
    test("validates private matching preferences", () => {
        expect(matchingPreferencesSchema.parse({
        ...
        }).countryPreference).toBe("US");
        expect(matchingPreferencesSchema.safeParse({
