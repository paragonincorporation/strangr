...
export class EntitlementService {
  ...
  async has(userId, key, now = new Date()) {
  ...
  async list(userId, now = new Date()) {
  ...
  async syncPlan(userId, planKey, sourceReference, validUntil, enabled) {
  ...
  async grantManual(actorId, userId, key, validUntil, purpose) {
  ...
  async revokeManual(actorId, userId, sourceReference, purpose) {
