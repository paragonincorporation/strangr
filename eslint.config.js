  ...
  },
  {
    ...
    rules: {
      'no-restricted-globals': [
        ...
        { name: 'document', message: 'Server code cannot use browser globals.' },
        { name: 'navigator', message: 'Server code cannot use browser globals.' },
        { name: 'localStorage', message: 'Server code cannot use browser globals.' },
      ],
    },
  },
  {
